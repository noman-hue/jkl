...
app = Flask(__name__)
app.secret_key = os.getenv('SECRET_KEY', 'supersecurelongrandomkey123!')

# MongoDB Atlas connection
MONGO_URI = os.getenv("mongodb+srv://nomankhalid:P@k1stan@cluster0.nlsqa.mongodb.net/")
...
def init_db():
    if not admin_collection.find_one({"username": "ahmed"}):
        admin_collection.insert_one({"username": "ahmed", "password": "123"})  # Hash passwords in production!
